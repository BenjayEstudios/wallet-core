    ...
    try {
        ...
        if(result.status === 'success') {
            ...
            if(result.data.length === 0) {
                lista.innerHTML = '<p style="text-align:center; color:var(--texto-secundario); padding: 20px;">No hay transacciones aún.</p>';
                return;
            }
...
function abrirDetalle(id) {
    ...
    // AQUI ESTA LA CORRECCION: innerHTML en lugar de innerText para que el HTML entity (&#127968;) se dibuje como emoji
