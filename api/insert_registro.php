...
if (!empty($data->monto) && !empty($data->descripcion) && !empty($data->id_categoria) && !empty($data->estado) && !empty($data->fecha_transaccion)) {
    try {
        $query = "INSERT INTO tbl_transacciones 
                  ...
                  VALUES (:id_usuario, :id_categoria, :tipo_flujo, :titulo, :descripcion, :monto, :fecha, :estado_pago)";
